...
\begin{document}
	...
	\begin{tabular}{p{2.2in} p{4.5in}}
  		\multirow{4}{*}{\includegraphics[scale=0.3]{photo}}\\
	...
	\begin{tabular}{ p{2in} p{2in}}
		\quad $\diamond$ \quad OpenCV			& * * * * * * - - - - \\
		\quad $\diamond$ \quad Matlab/ Octave		& * * * * * - - - - - \\
		\quad $\diamond$ \quad Arduino, Raspberry Pi	& * * * * * * * - - - \\
		\quad $\diamond$ \quad Android Studio		& * * * * * - - - - - \\
		\quad $\diamond$ \quad Embedded C		& * * * * * - - - - - \\
		\quad $\diamond$ \quad CATIA			& * * * * * * - - - - \\
		\quad $\diamond$ \quad PLC (Ladder Logic)	& * * * * * - - - - - \\
	\end{tabular}
	...
	Father’s Name:    Sadananda Adyanthaya\\
	Mother's Name:    Anita Sadananda\\
	Sex:              Male\\
	...
	% Date
	\vspace{.1in}
	\hfill  {\textbf{Date:} 24th April 2017}
